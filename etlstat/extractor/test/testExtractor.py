...
class TestExtractor(unittest.TestCase):
    ...
    def testPositionalIn(self):
       ...
       'PM21', 'PM22', 'PM3', 'PM4']
        ...
        post_type = ['O', 'float32', 'float32', 'O', 'O', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32',
        'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32',
        'float32', 'float32', 'float32', 'float32', 'float32', 'O', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32',
        'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32',
        'float32', 'O', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32',
        'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'O', 'float32', 'float32', 'float32', 'float32', 'float32']
       ...
       'KI211', 'KI212', 'KI212E']
        ...
        tec_type = ['O', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32',
        'float32', 'float32', 'float32', 'float32', 'float32', 'O', 'float32', 'float32', 'float32', 'float32', 'O', 'float32', 'float32',
        'float32', 'float32', 'float32', 'O', 'float32', 'float32', 'O', 'float32', 'float32', 'float32', 'float32', 'float32', 'float32',
