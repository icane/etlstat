"""
    Script para reemplazar masivamente rutas de pc-axis (ej: estadística TICH).
    ...
    la encuesta (ej: TICH), tal y como se indica en el archivo de configuracion.
...
def main(INPUT_DATA_PATH):
    """Replace massively pc-axis paths
